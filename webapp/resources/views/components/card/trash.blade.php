...
<div class="bg-white rounded-2xl shadow-[0_4px_20px_rgba(0,0,0,0.09)] border border-slate-100 p-6 hover:-translate-y-1 hover:shadow-[0_8px_30px_rgba(0,0,0,0.09)] transition-all duration-300">
    ...
    <img src="{{ asset('images/kategori/' . $image_name) }}" class="w-full h-36 object-cover rounded-xl mb-5 shadow-sm" alt="Plastik">
    <p class="text-center font-extrabold text-4xl text-slate-800 trash-count" data-base="{{ $total }}">{{ $total }}</p>
</div>
