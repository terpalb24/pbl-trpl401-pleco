            ...
            <div class="space-y-4">
                ...
                <div class="flex flex-col md:flex-row md:justify-between md:items-start gap-4">
                    ...
                    <p class="text-black text-sm md:text-lg leading-relaxed md:max-w-xl">
                        Dirancang untuk membantu mengurangi sampah kecil di perairan tenang, robot autonomous yang mampu
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                ...
                <div
                    ...
                    <div>
                        ...
                        <p class="text-xs text-black leading-relaxed">
                            PLECO mendukung terciptanya lingkungan perairan yang lebih bersih dan berkelanjutan melalui
        ...
        <section id="tentang" class="space-y-8 pt-6">
            ...
            <div class="flex flex-col md:flex-row gap-6 pt-4">
                ...
                <p class="text-black text-md md:text-[24px]  md:max-w-4xl  md:ml-auto">
                    ...
                    mengumpulkan sampah terapung secara mandiri. Lebih dari sekadar robot pembersih, PLECO hadir sebagai
                ...
                <div class="flex justify-between items-end">
                    <div class="space-y-2">
                        ...
                        <p class="text-black text-sm md:text-lg leading-relaxed max-w-xl">
                            Sekelompok mahasiswa yang menggabungkan teknologi, inovasi, dan kepedulian lingkungan dalam
                            pengembangan PLECO.
                        </p>
                    </div>
                    <!-- Slider Arrows -->
